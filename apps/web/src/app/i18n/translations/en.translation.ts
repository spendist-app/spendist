const en = {
  ...
  transactions: {
    ...
    filters: {
      ...
      clearCategories: 'Clear',
      clearTags: 'Clear',
      categoryFilterMode: 'Filter by categories',
      categoryFilterInactive: 'Enable to select groups or categories.',
      categoryFilterActive: '{{ count }} categories selected',
      selectAllCategories: 'Select all',
      clearAllCategories: 'Deselect all',
