...
Pod koniec 2022 roku pojawiła się długo oczekiwana nowa wersja. Wyglądała znacznie nowocześniej, a interfejs został wyraźnie odświeżony. Publiczne informacje z tego okresu potwierdzają, że aplikację [przepisano od początku i udostępniono jako nowy system](https://www.cashless.pl/12770-kontomierz-nowy-serwis).
...
Nie było to wyłącznie moje odczucie. W opublikowanej w 2023 roku [recenzji i zbiorze opinii o Kontomierzu](https://www.czerwona-skarbonka.pl/kontomierz-opinie/) zachowały się komentarze użytkowników dotyczące brakujących funkcji, problemów z migracją oraz różnic pomiędzy wersjami. Support wyjaśniał wówczas, że Kontomierz 2.0 powstał od zera, nadal jest rozwijany, a dawne opcje mają być stopniowo przywracane.
...
W lipcu 2023 roku Kontomierz poinformował, że [poprzednia wersja zostanie zamknięta 1 sierpnia 2023 roku](https://pl.linkedin.com/posts/kontomierz_finanse-kontomierz-oszcz%C4%99dzanie-activity-7081956777788850176-5bLR).

Zapowiedź wywołała obawy wśród osób, które korzystały ze starego systemu od wielu lat. Ostatecznie starszy panel nie zniknął całkowicie. Według stanu na 23 lipca 2026 roku nadal działa jego [publiczna strona logowania](https://secure.kontomierz.pl/k4/login), a [regulamin Kontomierza](https://kontomierz.pl/Regulamin) wciąż zawiera osobną część dotyczącą pierwszej wersji i planu kosztującego 9,99 zł miesięcznie lub 109,99 zł rocznie.
...
[Spendist jest projektem open source](https://github.com/spendist-app/spendist). Kod można przejrzeć, uruchomić na własnej infrastrukturze i rozwijać zgodnie z warunkami licencji GNU GPLv3.
...
Jeśli coś nie działa, można to zgłosić przez [GitHub Issues](https://github.com/spendist-app/spendist/issues). Jeśli brakuje funkcji, warto opisać konkretną sytuację, w której byłaby pomocna.
...
Jeżeli również chcesz wiedzieć, gdzie naprawdę trafiają twoje pieniądze, zapraszam do [rejestracji lub logowania w Spendist](https://spendist.app/).
